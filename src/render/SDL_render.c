...
//////////////////////////////////////////////////////////////////////
// CHANGED BY LWEISE for CREX
// change order of renderers: dx11 first
...
// added return int
int
SDL_RenderPresent(SDL_Renderer * renderer, int wait, int intervalOne)
{
    CHECK_RENDERER_MAGIC(renderer, );
    ...
    return renderer->RenderPresent(renderer, wait, intervalOne);
}
////////////////////////////////////////////////////
